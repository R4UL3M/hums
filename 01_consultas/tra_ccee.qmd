...
title: "Traumatología"
params:
  codigo: ["TRA_CADERA", "TRA_COLUMNA",  "TRA_FRACTURAS", "TRA_RODILLA"]
---
...
data <- read_csv(file = "ALL_consultas.csv") %>% filter(codigo %in% params$codigo)
```
...
codigo <- unique(substr(params$codigo,1,3))
...
saveRDS(object = get(paste0(codigo, "_pv")), file = paste0(codigo, "_pv", ".RDS"))
```
